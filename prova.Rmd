...
#p<-grid.arrange(p2,p1, nrows = 2, shareX = TRUE, heights = c(0.2,0.7))
...
ggplot(dfriccanza, aes(reorder(Economy.Strength, -n, sum), n))+
...
ggplot(df, aes(Star.Colour, Total))+
